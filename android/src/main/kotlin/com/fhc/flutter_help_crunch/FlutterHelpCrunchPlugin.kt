...
class FlutterHelpCrunchPlugin : FlutterPlugin, FlutterHelpCrunchApi {
  ...
  override fun initialize(
    ...
    val messageAreaTheme = HCMessageAreaTheme.Builder().applyFromTheme(theme).build()
    ...
    HelpCrunch.showChatScreen(
            ...
            object : Callback<Any?>() {
              ...
              override fun onError(message: String) {
                when (message) {
                  FlutterHelpCrunchUtil.HelpCrunchUserBlocked ->
                          Log.e(
                                  TAG,
                                  "onError::showChatScreen - ${FlutterHelpCrunchUtil.HelpCrunchUserBlocked}"
                          )
                  FlutterHelpCrunchUtil.HelpCrunchCantOpenChat ->
                          Log.e(
                                  TAG,
                                  "onError::showChatScreen - ${FlutterHelpCrunchUtil.HelpCrunchCantOpenChat}"
                          )
                }
