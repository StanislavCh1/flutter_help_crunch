...
struct ChatAreaThemeMessage: Hashable {
  ...
  var incomingBubbleLinkColor: Int64? = nil
  var outcomingBubbleLinkColor: Int64? = nil
  var attachmentIconsColor: Int64? = nil
  var incomingFileBackgroundColor: Int64? = nil
  var outcomingFileBackgroundColor: Int64? = nil
  var incomingFileIconColor: Int64? = nil
  var outcomingFileIconColor: Int64? = nil
  var fabDownBackgroundColor: Int64? = nil
  var fabBatchBackgroundColor: Int64? = nil
  var fabBatchTextColor: Int64? = nil
  ...
  static func fromList(_ pigeonVar_list: [Any?]) -> ChatAreaThemeMessage? {
    ...
    let incomingBubbleLinkColor: Int64? = nilOrValue(pigeonVar_list[19])
    let outcomingBubbleLinkColor: Int64? = nilOrValue(pigeonVar_list[20])
    let attachmentIconsColor: Int64? = nilOrValue(pigeonVar_list[21])
    let incomingFileBackgroundColor: Int64? = nilOrValue(pigeonVar_list[22])
    let outcomingFileBackgroundColor: Int64? = nilOrValue(pigeonVar_list[23])
    let incomingFileIconColor: Int64? = nilOrValue(pigeonVar_list[24])
    let outcomingFileIconColor: Int64? = nilOrValue(pigeonVar_list[25])
    let fabDownBackgroundColor: Int64? = nilOrValue(pigeonVar_list[26])
    let fabBatchBackgroundColor: Int64? = nilOrValue(pigeonVar_list[27])
    let fabBatchTextColor: Int64? = nilOrValue(pigeonVar_list[28])
...
struct PreChatThemeMessage: Hashable {
  ...
  var gdprLinkTextColor: Int64? = nil
  ...
  static func fromList(_ pigeonVar_list: [Any?]) -> PreChatThemeMessage? {
    ...
    let gdprLinkTextColor: Int64? = nilOrValue(pigeonVar_list[5])
